...
public class Instruction implements Serializable {
  ...
  private static Instruction[] ia = new Instruction[] {
    ...
    new Instruction("ldcr", 0x0f0 + 3, 0, JmpType.NOP, StackType.PUSH), // jopsys_hc
    ...
    new Instruction("cyc", 0x103, 0, JmpType.NOP, StackType.NOP), // jopsys_count is mapped cyc in jvm.asm
